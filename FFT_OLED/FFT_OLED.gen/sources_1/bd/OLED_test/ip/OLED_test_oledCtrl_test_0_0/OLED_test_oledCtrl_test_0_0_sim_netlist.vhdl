...
--               f:/Xilinx/Project/FFT_OLED/FFT_OLED/FFT_OLED.gen/sources_1/bd/OLED_test/ip/OLED_test_oledCtrl_test_0_0/OLED_test_oledCtrl_test_0_0_sim_netlist.vhdl
...
entity OLED_test_oledCtrl_test_0_0_SPI_ctrl is
  port (
  ...
  attribute ORIG_REF_NAME of OLED_test_oledCtrl_test_0_0_SPI_ctrl : entity is "SPI_ctrl";
end OLED_test_oledCtrl_test_0_0_SPI_ctrl;

architecture STRUCTURE of OLED_test_oledCtrl_test_0_0_SPI_ctrl is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity OLED_test_oledCtrl_test_0_0_debouncer is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of OLED_test_oledCtrl_test_0_0_debouncer : entity is "debouncer";
end OLED_test_oledCtrl_test_0_0_debouncer;

architecture STRUCTURE of OLED_test_oledCtrl_test_0_0_debouncer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity OLED_test_oledCtrl_test_0_0_delay100ms is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of OLED_test_oledCtrl_test_0_0_delay100ms : entity is "delay100ms";
end OLED_test_oledCtrl_test_0_0_delay100ms;

architecture STRUCTURE of OLED_test_oledCtrl_test_0_0_delay100ms is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity OLED_test_oledCtrl_test_0_0_oledCtrl is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of OLED_test_oledCtrl_test_0_0_oledCtrl : entity is "oledCtrl";
end OLED_test_oledCtrl_test_0_0_oledCtrl;

architecture STRUCTURE of OLED_test_oledCtrl_test_0_0_oledCtrl is
...
begin
  oled_vbat <= \^oled_vbat\;
  oled_vdd <= \^oled_vdd\;
DELAY: entity work.OLED_test_oledCtrl_test_0_0_delay100ms
     port map (
...
OLED_SC: entity work.OLED_test_oledCtrl_test_0_0_SPI_ctrl
     port map (
      E(0) => OLED_SC_n_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity OLED_test_oledCtrl_test_0_0_oledCtrl_test is
  port (
    oled_SCLK : out STD_LOGIC;
    oled_SDIN : out STD_LOGIC;
    oled_rst_n : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of OLED_test_oledCtrl_test_0_0_oledCtrl_test : entity is "oledCtrl_test";
end OLED_test_oledCtrl_test_0_0_oledCtrl_test;

architecture STRUCTURE of OLED_test_oledCtrl_test_0_0_oledCtrl_test is
  signal switch : STD_LOGIC;
begin
DEB: entity work.OLED_test_oledCtrl_test_0_0_debouncer
     port map (
      A => A,
      clk => clk,
      rst => rst,
...
DUT: entity work.OLED_test_oledCtrl_test_0_0_oledCtrl
     port map (
      clk => clk,
      oled_SCLK => oled_SCLK,
      oled_SDIN => oled_SDIN,
...
entity OLED_test_oledCtrl_test_0_0 is
  ...
  attribute NotValidForBitStream of OLED_test_oledCtrl_test_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of OLED_test_oledCtrl_test_0_0 : entity is "OLED_test_oledCtrl_test_0_0,oledCtrl_test,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of OLED_test_oledCtrl_test_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of OLED_test_oledCtrl_test_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of OLED_test_oledCtrl_test_0_0 : entity is "oledCtrl_test,Vivado 2020.2";
end OLED_test_oledCtrl_test_0_0;

architecture STRUCTURE of OLED_test_oledCtrl_test_0_0 is
...
inst: entity work.OLED_test_oledCtrl_test_0_0_oledCtrl_test
     port map (
      A => A,
      clk => clk,
      oled_SCLK => oled_SCLK,
