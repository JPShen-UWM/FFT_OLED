...
HD_PWD='F:/Xilinx/Project/FFT_OLED/FFT_OLED/FFT_OLED.runs/OLED_test_oledCtrl_test_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_test_oledCtrl_test_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_test_oledCtrl_test_0_0.tcl
